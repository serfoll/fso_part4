...
describe('favorite blog', () => {
  ...
  test('when list is has multiple blogs, equals most liked', () => {
  ...
  test('when list has multiple similar likes, equals single most liked', () => {
    assert.deepStrictEqual(listHelper.favoriteBlog(multipleLikesBlog), multipleLikesBlog[2])
  })
})
